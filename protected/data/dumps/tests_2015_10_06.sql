...
INSERT INTO `tbl_answer` (`id`, `question_id`, `title`, `right`, `active`, `sorter`) VALUES
(1,	2,	'Первый ответ',	0,	0,	0),
(2,	2,	'Второй ответ',	0,	1,	0),
(3,	2,	'Третий ответ',	0,	1,	0),
(4,	2,	'Четвёртый ответ',	1,	1,	0),
(8,	9,	'gdxrdxrg',	0,	1,	0),
(9,	9,	'dxrgxdrgxdrg',	0,	1,	0),
(11,	1,	'esf',	0,	1,	0),
(12,	2,	'xgdxrg',	0,	1,	0),
(13,	1,	'xdgxdr',	1,	1,	0),
(14,	9,	'ddxzfzf',	1,	1,	0),
...
(16,	4,	'fcthcfth',	0,	1,	0),
(17,	10,	'cfg',	0,	1,	0),
(18,	10,	'vndgxxdgd',	1,	1,	0),
(19,	10,	'nfcbdzvbdfx',	0,	1,	0),
(20,	4,	'dxvv',	1,	1,	0);
...
INSERT INTO `tbl_question` (`id`, `test_id`, `question`, `explanation`, `filename`, `title`, `active`, `sorter`) VALUES
(1,	30,	'/files/question/ebd08d3750cbe86c5aec5b9ef00903ad.png',	'/files/explanation/f0282746a2380fe55629bab7afadeefd.pdf',	'анд_1.pdf',	'Вопрос второй (косвенный)',	1,	0),
(2,	30,	'/files/question/54cae03bd65c837fc2fd6586a359fe16.jpg',	'/files/explanation/bb5cd4f72b13f1b63f919e18941101a0.pdf',	'єль_1.pdf',	'Вопрос номер один (по существу)',	1,	0),
(4,	31,	'/files/question/d146dc539b92908025ae9ab72a503f79.jpg',	'/files/explanation/5a88f48c6870f90646b380e84b96115c.pdf',	'zyxel-keenetic-giga.pdf',	'Такой себе вопрос',	1,	0),
(9,	30,	'/files/question/2a729cd19d6dc3bb697b73a29886d31a.png',	'/files/explanation/4a5fce6f80d3dffbea9e4d65c10b47a5.pdf',	'анд_1.pdf',	'Так себе вопрос',	1,	0),
(10,	31,	'/files/question/85a88f0f0a42478a797eaf9696c671de.jpg',	'/files/explanation/491856b0e03c763615db1cc598b819b2.pdf',	'єль_1.pdf',	'dxg',	1,	0);

DROP TABLE IF EXISTS `tbl_results_text`;
CREATE TABLE `tbl_results_text` (
  `from` int(11) NOT NULL,
  `till` int(11) NOT NULL,
  `text` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `tbl_results_text` (`from`, `till`, `text`) VALUES
(96,	100,	'Супер результат!'),
(81,	95,	'Отлично, но не лучший результат'),
(80,	61,	'gdrgdr'),
(0,	0,	'fzsezse');
...
INSERT INTO `tbl_test` (`id`, `title`, `active`) VALUES
(30,	'Первый тест',	1),
(31,	'Второй тест',	1);
