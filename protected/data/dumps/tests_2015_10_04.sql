...
INSERT INTO `tbl_question` (`id`, `test_id`, `explanation`, `title`, `active`, `sorter`) VALUES
(1,	30,	'sdgs',	'Вопрос второй (косвенный)',	1,	0),
(2,	30,	'xd',	'Вопрос номер один (по существу)',	1,	2),
(4,	31,	'',	'Такой себе вопрос',	0,	0);
