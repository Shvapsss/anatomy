...
(2,	2,	'Второй ответ',	1,	1,	0),
(3,	2,	'Третий ответ',	0,	1,	0),
(4,	2,	'Четвёртый ответ',	0,	1,	0),
(8,	9,	'gdxrdxrg',	0,	1,	0),
...
(1,	30,	'',	'',	'',	'Вопрос второй (косвенный)',	1,	0),
(2,	30,	'',	'',	'',	'Вопрос номер один (по существу)',	1,	0),
(4,	31,	'',	'',	'',	'Такой себе вопрос',	1,	0),
(9,	30,	'',	'',	'',	'Так себе вопрос',	0,	0),
(10,	31,	'',	'',	'',	'dxg',	1,	0);
